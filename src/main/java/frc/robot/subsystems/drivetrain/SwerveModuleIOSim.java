...
public class SwerveModuleIOSim implements SwerveModuleIO {
    ...
    public void setDriveVelocity(double velocityMetersPerSecond) {
        double feedforward = driveFeedforward.calculate(velocityMetersPerSecond);
        double pidCorrection = drivePID.calculate(driveVelocityMetersPerSecond, velocityMetersPerSecond);
