...
public class AimAndShoot extends Command{
    ...
    private double[] notShootingTolerances = new double[] {1.0, 1.0, 0.5, 0.5};
    ...
    public void execute() {
        ...
        if(driverReadyToShoot.get()) {
            ...
            turret.aimAtTargetAndShoot(robotToTargetAngle, shootingValues[1], (shootingValues[0]*1.40)-0.4); //*1.33333)-0.666667
